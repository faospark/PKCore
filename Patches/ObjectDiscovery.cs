...
public static class ObjectDiscovery
{
    ...
    {
        var mdat = PKCore.Patches.MachiLoader_Load_Patch.LastLoadedMachiDat;
        if (mdat == null)
        {
            Plugin.Log.LogWarning($"[ObjectDiscovery] MACHIDAT not yet cached (MachiLoader_Load_Patch). Native object discovery skipped.");
            return;
        }
